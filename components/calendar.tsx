...
export function Calendar() {
  ...
  const monthCompletion = Math.round((completedDays / totalDays) * 100);
    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-card rounded-2xl p-8 border border-border">
            ...
            <div className="grid grid-cols-7 gap-3">
              ...
              {days.map((day) => {
                ...
                return <CalendarDay key={day} day={day} stats={stats} isToday={isToday} dateStr={dateStr} />;
              })}
            </div>
          </div>
        </div>
        ...
        <div className="bg-card rounded-2xl p-8 border border-border h-fit">
          <h3 className="font-semibold text-foreground mb-6 text-lg">Weekly Breakdown</h3>
              ...
              return (
                <div key={`week-${weekIndex}`} className="p-4 bg-muted rounded-lg">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-sm font-bold text-primary">{weekCompletion}/7</span>
                  </div>
                    ...
                    {weekDays.map((day) => {
                      ...
                      return (
                        <div
                          ...
                          title={`Day ${day}: ${stats?.completed || 0}/${stats?.total || 0}`}
                        />
                      );
                    })}
                  </div>
