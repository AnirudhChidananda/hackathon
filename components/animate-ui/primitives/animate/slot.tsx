...
import { motion, isMotionComponent, type HTMLMotionProps, HTMLElements } from "motion/react";
import { cn } from "@/lib/utils";

type AnyProps = Record<string, unknown>;

type DOMMotionProps<T extends HTMLElement = HTMLElement> = Omit<HTMLMotionProps<keyof HTMLElements>, "ref"> & { ref?: React.Ref<T> };
