  ...
  const toggleCall = async () => {
    if (callActive) vapi.stop();
      ...
      try {
        ...
        await vapi.start(process.env.NEXT_PUBLIC_VAPI_API_MOTIVATION_KEY!, {
          variableValues: {
            full_name: fullName,
            user_id: user?.id,
          },
    ...
    <div>
      <div className="container mx-auto px-4 h-full max-w-5xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">Have a voice conversation with our Motivation Coach for a personalized session</p>
        </div>
            ...
            <div className="aspect-video flex flex-col items-center justify-center p-6 relative">
              ...
              <div className="relative size-32 mb-4">
                ...
                <div className="relative w-full h-full rounded-full bg-card flex items-center justify-center border border-border overflow-hidden">
                  ...
                  <img src="/h3.png" alt="AI Assistant" className="w-full h-full object-cover" />
                </div>
              </div>

              <h2 className="text-xl font-bold text-foreground">Motivation Coach</h2>
            ...
            <div className="space-y-3">
              {messages.map((msg, index) => (
                <div key={index} className="message-item animate-fadeIn">
                  <div className="font-semibold text-xs text-muted-foreground mb-1">{msg.role === "assistant" ? "Motivation Coach" : "You"}:</div>
              ...
              {callEnded && (
                <div className="message-item animate-fadeIn">
                  ...
                  <p className="text-foreground">Your motivation session has been completed. Redirecting to your profile...</p>
                </div>
              )}
            </div>
          </div>
...
export default AIMotivationPage;
